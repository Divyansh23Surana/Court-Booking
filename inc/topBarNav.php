                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span><img src="uploads/system-cover.png" alt="uploads/system-cover.png" onerror="this.onerror=null; this.src='uploads/system-cover.png'" id="user_avatar" class="img-fluid img-thumbnail rounded-circle border-dark"></span> Howdy, <?= $_settings->userdata('name') ?>
