<script>
  // Check if the current URL is the booking_list page
  if (window.location.href.includes("?p=booking_list")) {
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $time24Hour = "$row[time_from]";
                                    $time12HourFormat = date("h:i A", strtotime($time24Hour));
                                    $time_from=$time12HourFormat;  
                                        if($row['date'] == $row['time_from']){
                                            echo date("M d, Y", strtotime($row['date']));
                                        }else{
                                            echo date("M d, Y", strtotime($row['date']))." - ".$time_from;
                                        }
                                    ?>
                                </td>
